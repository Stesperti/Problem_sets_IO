...
\begin{document}
    ...
    \subsection*{2}
In particular let's start definingMultinomial Logit Market Shares
$$
s_{ij}(\theta) 
= \Pr(d_{ij} = 1) 
= \int 
...
{wired} as the two nests for the inside goods. The results are presented in
...
diversion ratio matrices.
    ...
    \input{ps3/Latex/table_diversion_est}
